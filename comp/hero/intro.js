...
export default function Intro() {
  ...
  return (
    ...
    >
      <img className='bg w-16 md:w-32 lg:w-48' src="./hero/bg1.jpg"/>
      <div className="hero-content ">
        <div className="content-wrap ">
        <h1 className="text-white slideLeft">WEB ZONE</h1>
      ...
      <div aria-label="Newest Photos">
        <div className="carousel" data-carousel>
                  ...
                  <div className="content">
                    <div className="content-wrap">
                      ...
                      <p className="hero-text">
                        ...
                        to escort you to the airport, events, wedding, or
                        weekend getaway.
                      </p>
                ...
                <>
                  <div className="content">
                    <div className="content-wrap">
                      ...
                      <p className="hero-text">
                        Don't be a threat to yourself and other passengers on
                        the road. Book a safe driver Now and make the smarter
                        choice.
                      </p>
                      <button className="action-btn">Call Now</button>
                      <button className=" main-action-btn">WhatsApp Now</button>
                ...
                <>
                  <div className="content">
                    <div className="content-wrap">
                      ...
                      <p className="hero-text">
                        Expect only the best from our wide array of
                        professionally trained drivers as they will take you to
          ...
          <button className="go-down"><MobileDownload32 /></button>
          <ol className="carousel-indicators">
              <li className={silde == 1 && "active"} onClick={()=> setslide(1)}></li>
              <li className={silde == 2 && "active"} onClick={()=> setslide(2)}></li>
              <li className={silde == 3 && "active"} onClick={()=> setslide(3)}></li>
